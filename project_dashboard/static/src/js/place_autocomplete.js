...
*/
odoo.define('project_dashboard.place_autocomplete', function(require){

    var basic_fields = require('web.basic_fields');
    var registry = require('web.field_registry');
    var MapWidget = require('project_dashboard.map_widget');
    ...
    var place_autocomplete = basic_fields.FieldChar.extend({
        ...
        on_ready: function(){
            ...
            geocoder.geocode({'address': self.recordData.country_id.data.display_name}, function (results, status) {
                if (status === 'OK') {
